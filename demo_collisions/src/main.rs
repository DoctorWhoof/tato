...
async fn main() {
    ...
    loop {
        ...
        if let Some(col) = &collision {
            ...
            world.framebuf.draw_line(pos.x as i32, pos.y as i32, x1 as i32, y1 as i32, Color32::yellow(), 255);
            world.framebuf.draw_filled_rect(tato::Rect { x: pos.x as i32-1, y:pos.y as i32-1, w:3, h:3 }, Color32::red());
        }
