...
impl FixedCamera {
    pub fn new(vid: &mut VideoChip) -> Self {
        ...
        let _palette_bg = vid.push_palette([BG, GREEN, BLACK, BLACK]);
        let palette_smiley = vid.push_palette([BG, YELLOW, BLACK, BLACK]);
        let palette_cycler = vid.push_palette([BG, WHITE, BLACK, BLACK]);
        ...
        let tile = vid.new_tile(8, 8, &SMILEY);
        ...
        Self {
            ...
            smileys: core::array::from_fn(|_| Entity {
                ...
                x: (rng.gen_float() * 255.0), // - 32_000.0,
                y: (rng.gen_float() * 255.0), // + 32_000.0,
                tile,
