...
impl Color32 {
    ...
    pub fn gray_dark() -> Self { Self { r: 48, g: 48, b: 48 ,a:255 } }
    
    pub fn gray() -> Self { Self { r: 128, g: 128, b: 128 ,a:255 } }
    
    pub fn gray_light() -> Self { Self { r: 192, g: 192, b: 192 ,a:255 } }
    
    pub fn white() -> Self { Self { r: 255, g: 255, b: 255 ,a:255 } }

    pub fn red() -> Self { Self { r: 255, g: 0, b: 0 ,a:255 } }

    pub fn orange() -> Self { Self { r: 255, g: 128, b: 0 ,a:255 } }

    pub fn yellow() -> Self { Self { r: 255, g: 255, b: 0 ,a:255 } }
    
    pub fn green_light() -> Self { Self { r: 109, g: 255, b: 109 ,a:255 } }

    pub fn green_medium() -> Self { Self { r: 36, g: 219, b: 36 ,a:255 } }

    pub fn green_dark() -> Self { Self { r: 36, g: 146, b: 36 ,a:255 } }
